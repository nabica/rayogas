...
/***/ "./resources/js/rayogas/bootstrap.js":
/*!*******************************************!*\
  !*** ./resources/js/rayogas/bootstrap.js ***!
  \*******************************************/
...
/***/ "./resources/js/rayogas/components/communicationsPopup.js":
/*!****************************************************************!*\
  !*** ./resources/js/rayogas/components/communicationsPopup.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (!js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].get('communications')) {
  js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].set('communications', 'checked');
  var comunnicationsPopup = new bootstrap.Modal(document.getElementById("communications-popup"), {});
  comunnicationsPopup.show();
}

/***/ }),

/***/ "./resources/js/rayogas/components/footer.js":
/*!***************************************************!*\
  !*** ./resources/js/rayogas/components/footer.js ***!
  \***************************************************/
/***/ (() => {
...
/***/ "./resources/js/rayogas/components/form-validation.js":
/*!************************************************************!*\
  !*** ./resources/js/rayogas/components/form-validation.js ***!
  \************************************************************/
/***/ (() => {
...
/***/ "./resources/js/rayogas/components/formRequest.js":
/*!********************************************************!*\
  !*** ./resources/js/rayogas/components/formRequest.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  var data = {};
  var nameInput = formRequest.querySelector('[name="name"]');
  var telephoneInput = formRequest.querySelector('[name="telephone"]');
  ...
  btnNextStep.addEventListener("click", function (event) {
    event.preventDefault();
    var inputs = [nameInput, telephoneInput, personSelect];
  ...
  formRequest.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
      var type, cilinderInputs, instalationInputs, granelInputs, validateOptions, validateInputs, _data, token, formData, dataKeys, response, popupModal, allInputs;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              e.preventDefault();
              type = requestTypeSelector.value;
              cilinderInputs = document.querySelectorAll(".form-request-service__inputs--cilinder");
              instalationInputs = document.querySelectorAll(".form-request-service__inputs--installation");
              granelInputs = document.querySelectorAll(".form-request-service__inputs--granel");
              validateOptions = {
                cilindro: function cilindro() {
                  return validateInputs(cilinderInputs);
                },
                granel: function granel() {
                  return validateInputs(granelInputs);
                },
                instalaciones: function instalaciones() {
                  return validateInputs(instalationInputs);
                }
              };

              validateInputs = function validateInputs(inputs) {
                var selectedInputs = Array.from(inputs).map(function (input) {
                  return input.querySelectorAll("input, select")[0];
                });

                if (selectedInputs.some(function (input) {
                  return !input.value;
                })) {
                ...
                var otherInputs = [nameInput, telephoneInput, personSelect, businessNameInput];
              ...
              token = formRequest.querySelector("#form-request-service__token").value;
              formData = new FormData();
              formData.append("_token", token);
              dataKeys = Object.keys(_data);
              dataKeys.forEach(function (key) {
                formData.append(key, _data[key]);
              });
              _context.next = 17;
              return fetch("/solicitud-servicio", {
                method: "POST",
                body: formData
              });
            ...
            case 17:
              ...
              if (response.status === 200) {
                ...
                popupModal.show();
                allInputs = formRequest.querySelectorAll("input, select");
            ...
            case 21:
              ...
              alert("Tenemos algunos problemas ´por favor intente de nuevo mas tarde");
...
/***/ "./resources/js/rayogas/components/navbar.js":
/*!***************************************************!*\
  !*** ./resources/js/rayogas/components/navbar.js ***!
  \***************************************************/
/***/ (() => {
...
/***/ "./resources/js/rayogas/components/transparency.js":
/*!*********************************************************!*\
  !*** ./resources/js/rayogas/components/transparency.js ***!
  \*********************************************************/
/***/ (() => {

var tabElements = document.querySelectorAll('button[id^="transparency-tab-"]');
tabElements.forEach(function (tab) {
  tab.addEventListener("show.bs.tab", function (event) {
    ...
    if (id.includes("-mobile")) {
      var newId = id.replace("-mobile", "");
      foundedTab = document.querySelector("#".concat(newId));
    } else {
      foundedTab = document.querySelector("#".concat(id, "-mobile"));
    }
...
/***/ "./resources/js/rayogas/sections/pqrs.js":
/*!***********************************************!*\
  !*** ./resources/js/rayogas/sections/pqrs.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var labelFile = workWithUsForm.querySelector("#file-label");
  var helpMessage = workWithUsForm.querySelector(".help-message");
  inputFile.addEventListener("change", function (e) {
    labelFile.textContent = e.currentTarget.files[0].name;
  }); // Events

  workWithUsForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(event) {
      var formData, fileType, fileSize, response, popupModal;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 10;
              return axios.post("/trabaja-con-nosotros", formData);
...
/***/ "./resources/js/rayogas/themeAndSize.js":
/*!**********************************************!*\
  !*** ./resources/js/rayogas/themeAndSize.js ***!
  \**********************************************/
/***/ (() => {
...
"use strict";
/*!*************************************!*\
  !*** ./resources/js/rayogas/app.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _themeAndSize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./themeAndSize */ "./resources/js/rayogas/themeAndSize.js");
/* harmony import */ var _themeAndSize__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_themeAndSize__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _bootstrap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bootstrap */ "./resources/js/rayogas/bootstrap.js");
...
/* harmony import */ var _components_navbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/navbar */ "./resources/js/rayogas/components/navbar.js");
...
/* harmony import */ var _components_formRequest__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/formRequest */ "./resources/js/rayogas/components/formRequest.js");
/* harmony import */ var _components_footer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/footer */ "./resources/js/rayogas/components/footer.js");
...
/* harmony import */ var _components_form_validation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/form-validation */ "./resources/js/rayogas/components/form-validation.js");
/* harmony import */ var _components_form_validation__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_form_validation__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_transparency__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/transparency */ "./resources/js/rayogas/components/transparency.js");
...
/* harmony import */ var _components_communicationsPopup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/communicationsPopup */ "./resources/js/rayogas/components/communicationsPopup.js");
/* harmony import */ var _sections_workWithUs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sections/workWithUs */ "./resources/js/rayogas/sections/workWithUs.js");
/* harmony import */ var _sections_pqrs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./sections/pqrs */ "./resources/js/rayogas/sections/pqrs.js");
/* harmony import */ var _sections_transparency__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./sections/transparency */ "./resources/js/rayogas/sections/transparency.js");
/* harmony import */ var _sections_transparency__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_sections_transparency__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _maps__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./maps */ "./resources/js/rayogas/maps.js");
