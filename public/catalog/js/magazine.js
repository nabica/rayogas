...
function loadPage(page, pageElement) {
    ...
    img.attr("src", "catalog/pages/" + page + ".jpg");
...
function loadRegions(page, element) {
    $.getJSON("catalog/pages/" + page + "-regions.json").done(function (data) {
...
function loadLargePage(page, pageElement) {
    ...
    img.attr("src", "catalog/pages/" + page + "-large.jpg");
}
...
function setPreview(view) {
    var previewWidth = 112,
        previewHeight = 73,
        previewSrc = "catalog/pages/preview.jpg",
