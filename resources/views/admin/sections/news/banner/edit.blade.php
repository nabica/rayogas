        ...
        <div class="page-title-box d-md-flex align-items-center justify-content-between">
            ...
            {{-- <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.blog.banner.index') }}">Banner principal</a></li>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                {!! Form::open(['route' => ['admin.blog.banner.update', $banner->id], 'method' => 'put', 'files' => true]) !!}
                    <div class="row">
                        <div class="col-md-6">
