...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                {!! Form::open(['route' => ['admin.home.feature.update', $feature->id], 'method' => 'put', 'files' => true]) !!}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('image_description', $feature->image_description , ['class' => 'form-control']) !!}
                            </div>
                        </div>
