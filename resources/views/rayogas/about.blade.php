...
<section class="section" id="about-team">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="{{ isset($aboutFeatures[0]->image) ? $aboutFeatures[0]->image_url : asset('images/web/about/nosotros_img_principal.png') }}" class="img-fluid" alt="nuestro equipo">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-9">
                <div id="about-services">
                    <div class="content">
                        ...
                        <div class="image">
                            <div>
                                <img src="{{ isset($aboutFeatures[1]->image) ? $aboutFeatures[1]->image_url :  asset('images/web/about/nosotros_img_cilindros.png') }}" class="img-flui" alt="cilindros">
                            </div>
