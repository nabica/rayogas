...
@section('metatags_facebook')
    <meta property="og:title"
          content="{{ config('app.name') }} | Comunícate con nosotros ante cualquier inquietud">
    ...
    <meta property="og:image"
          content="{{ asset('images/web/pqrs/pqrs_img_principal.png') }}">
@endsection
            ...
            <div class="row align-items-center pqrs__container">
                <div class="col-12  col-lg-5 pqrs__side-banner">
                    <div class="pqrs__side-banner-text">
                        ...
                        <p>Diligencia los siguientes campos para enviar a nuestra
                            área de servicio al cliente la petición,
                            queja, reclamo o sugerencia que tengas y poder
                            evaluarla.</p>
                    </div>
                    <div class="pqrs__side-banner-image">
                        <img src="{{ asset('images/web/pqrs/pqrs_img_principal.png') }}"
                             alt="Rayogas-gas-glp-escribenos-para-cualquier-inquetud"
                             class="w-100">
                    </div>
                </div>
                <div class="col-12 col-lg-7">
                    <form class="form__general pqrs__form row g-3 needs-validation"
                        ...
                        <div class="col-md-6">
                            <label for="object" class="form-label">Objeto
                                solicitud</label>
                            <div class="select">
                                <select type="text" class="form-control"
                                        id="object" required name='object'>
                                    <option disabled selected value="">
                                        Selecciona una opcion</option>
                                    @foreach ($pqrs as $pqr)
                                        <option value="{{ $pqr->name }}">
                                            {{ $pqr->name }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="select">
                                <select type="text" class="form-control"
                                    ...
                                    <option value="Reclamación">Reclamación
                                    </option>
                        ...
                        <p class="form__general__disclaimer">Esta información esta
                            bajo la <a
                               href="{{ asset('pdfs/politica_datos_personales.pdf') }}"
