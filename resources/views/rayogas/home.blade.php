...
@section('metatags_facebook')
    <meta property="og:title"
          content="{{ config('app.name') }} | Somos energía que mueve a un país - GLP">
...
@endsection
@section('title', config('app.name') . ' | Somos energía que mueve a un país -
    GLP')
                ...
                <div class="col-md-6">
                    <div id="home-main-image">
                        @if (isset($homeFeature->image))
                            <img src="{{ $homeFeature->image_url }}"
                                 class="img-fluid"
                                 alt="Rayogas-glp-colombiano-para-el-hogar">
                        @else
                            <img src="{{ asset('images/web/home/home_img_principal.png') }}"
                                 class="img-fluid"
                                 alt="Rayogas-glp-colombiano-para-el-hogar">
                        @endif
                        <div class="content">
    ...
    <div class="container">
        <section class="section">
            @component('rayogas.components.heading-title')
                ...
                @endslot
                @slot('description')
                    Contamos con un <strong>amplio portafolio de GLP en cilindros y a
                        granel</strong> para
                    nuestros clientes residenciales, comerciales e industriales,
                    <strong>adaptándonos a sus necesidades</strong>
                    específicas.
                @endslot
            @endcomponent
            ...
            <div class="tabs">
                ...
                <div class="tab-content tabs-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="products-content-1"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_hogar_1.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-en-el-hogar-para-calentadores">
                                <h3>Energía para tu hogar</h3>
                                <p>Con el <strong>GLP</strong> tienes una
                                    alternativa de <strong>producción de
                                        calor</strong> muy versátil, de manera
                                    sencilla, económica y sin estructuras
                                    complicadas obtienes confort para tu familia o
                                    para quienes te visiten. </p>

                                <p>Además de obtener un espacio con mejor calidad de
                                    aire para una tranquilidad mayor. </p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_hogar_2.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-como-energia">
                                <h3>Diferentes usos</h3>
                                <p>El gran poder calorífico del GLP permite su uso
                                    en diferentes lugares del hogar, como:
                                    cocina, calefactores de ambiente, calentadores
                                    de agua, climatización para piscina,
                                    cilindros para asadores, chimeneas, entre otros.
                                </p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_hogar_3.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-combustible-limpio-para-el-hogar">
                                <h3>Cuida tu ambiente</h3>
                                <p>El GLP es un combustible limpio ya que no deja
                                    residuos, cenizas, ni olor, por estar
                                    libre de plomo, azufre y otros productos
                                    contaminantes.</p>

                                <p>Miles de personas lo eligen al ser una
                                    alternativa energética limpia y altamente
                                    eficiente, que además mantiene los bosques
                                    libres de la deforestación ya que evita el
                                    uso de leña. </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_industria_1.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-para-las-industrias-como-energia-flexible">
                                <h3>Un facilitador para tu crecimiento</h3>
                                <p>"Energía flexible, limpia y segura es la que
                                    recibes con GLP Rayogas, una oportunidad de
                                    evolucionar en tu sector.
                                </p>
                                <p>
                                    Puedes utilizarlo en: Corte industrial,
                                    carburación montacargas, calderas, fundición,
                                    calefacción, gasodomésticos y refrigeración
                                    industrial y generación de energía.</p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_industria_2.png') }}"
                                     class="w-100"
                                     alt="Rayogas-glp-con-poder-calorifico-mayor-que-el-gas-natural">
                                <h3>Optimiza tus resultados</h3>
                                <p>Usa GLP, un gas con poder aproximadamente 2,5
                                    veces mayor que el gas natural para
                            ...
                            <div class="col-md-4">
                                ...
                                <p>De inicio a fin estamos contigo, desde la primera
                                    asesoría, hasta la instalación y
                                    mantenimiento del producto para hacer crecer tu
                                    industria. Puedes usarlo para:
                                    Construcción, impermeabilización, flamear y usos
                                    náuticos. </p>
                            </div>
                        </div>
                        {{-- <div class="container-button-interest">
                    ...
                    <div class="tab-pane fade " id="products-content-3"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_agro_1.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-para-procesos-de-produccion">
                                <h3>Cuida tus procesos</h3>
                                <p>El detalle en tus procesos de producción puede
                                    marcar la diferencia. Usa el poder del GLP
                                    desde el primer hasta el último proceso. </p>

                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_agro_2.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-para-crear-temperaturas-en-agricultura">
                                <h3>Temperaturas ideales</h3>
                                <p>Logra la temperatura que necesitas en tu
                                    producción de manera estable y controlada. </p>
                                <p>Asesoría en el manejo de temperatura adecuada
                                    para tu producción.</p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_agro_3.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-para-todo-tipo-de-industrias">
                                <h3>Para todo tipo de agroindustria</h3>
                                <p>Accede al rendimiento y potencia del GLP en
                                    procesos de esterilización, pasteurización,
                                    calderas, cocción, secado, conserva, granjas,
                                    criaderos y más. </p>
                            </div>
                        </div>
                        {{-- <div class="container-button-interest">
                    ...
                    <div class="tab-pane fade " id="products-content-4"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_horeca_1.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-para-restaurantes-hoteles-spas">
                                <h3>Espacios acogedores</h3>
                                <p>Ambienta cada espacio de tu hotel, restaurante,
                                    spa, entre otros, con temperaturas
                                    ideales que agradarán a tus clientes.</p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_horeca_2.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-combustible-limpio-para-la-empresa">
                                <h3>Sin contaminación</h3>
                                <p>El GLP es un combustible limpio que no deja
                                    residuos y está libre de plomo, azufre y
                                    otros productos contaminantes.</p>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ asset('images/web/home/services/home_servicios_horeca_3.png') }}"
                                     class="w-100"
                                     alt="Rayogas-gas-glp-util-en-hornos-calentadores-zonas-humedas">
                                <h3>Funcional para tu negocio</h3>
                                <p>Úsalo en estufas industriales, calefactores,
                                    chimeneas, climatización de piscinas,
                                    hornos, calderas, lavanderías, zonas húmedas ¡y
                                    más! </p>
                            </div>
                        </div>
                        {{-- <div class="container-button-interest">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 text-center mt-1">
                    <a href="{{ route('rayogas.rates') }}"
                       class="btn btn-primary">Conócelas aquí </a>
                </div>
            </div>
        </div>
    </section>
