        ...
        <div class="transparency__card mb-5">
            <div class="row">
                <div class="col-12 transparency__card-header">
                    <img src="{{ asset('images/web/transparency/icn_transparencia_politicas.png') }}" alt="">
                    <h2>Políticas, lineamientos y manuales</h2>
                </div>
            </div>
            <div class="row flex-column-reverse flex-lg-row">
                <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                    <h4 class="mb-3 mb-lg-4">POLÍTICA DE SEGURIDAD DE LA INFORMACIÓN EN EL SITIO WEB</h4>
                    <p>La Política de Seguridad y Privacidad de la Información es la declaración general que
                        ...
                        Sistema de Gestión de Seguridad de la Información - SGSI, por medio de la generación
                        y publicación de sus políticas, procedimientos e instructivos, así como de la
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 transparency__header-text">
                    <p class="bottomLine "> <strong class="gray">RAYOGAS S.A. ESP,</strong> para asegurar la
                        dirección
                        estratégica de la
                        Empresa, establece la compatibilidad de la política de seguridad de la información y
                        los objetivos de seguridad de la información, estos últimos correspondientes a:</p>
                </div>
        ...
        <div class="container">
            <div class="row politics__scope">
                <div class="col-12 col-md-6">
                    ...
                    <p>Esta política aplica a toda RAYOGAS S.A. ESP, sus funcionarios, contratistas y
                        terceros
                        de RAYOGAS S.A. ESP y la ciudadanía en general.</p>
                </div>
                <div class="col-12 col-md-6">
                    <h2 class="sideLine ">Nivel de cumplimiento:</h2>
                    <p>Todas las personas cubiertas por el alcance y aplicabilidad deberán dar cumplimiento
                        un
            ...
            <div class="row politics__list">
                <div class="col-12 politics__list-header">
                    <p class="bottomLine transparency__header-text">A continuación se establecen las
                        políticas
                        de
                ...
                <div class="col-12 politics__list-body">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <p><strong class="gray">a)</strong> RAYOGAS S.A. ESP decidido definir,
                                implementar,
                            ...
                            <p><strong class="gray">b)</strong> Las responsabilidades frente a la seguridad
                                de
                            ...
                            <p><strong class="gray">d)</strong> RAYOGAS S.A. ESP protegerá la información
                                ...
                                financieros, operativos o legales debido a un uso incorrecto de esta. Para
                                ello
                                es fundamental la aplicación de controles de acuerdo con la clasificación de
                                la
                                información de su propiedad o en custodia.</p>
                            <p><strong class="gray">e)</strong> RAYOGAS S.A. ESP protegerá su información de
                                las
                                amenazas originadas por parte
                                del personal.</p>
                            <p><strong class="gray">f)</strong> RAYOGAS S.A. ESP protegerá las instalaciones
                                de
                                procesamiento y la
                                infraestructura tecnológica que soporta sus procesos críticos.</p>
                        </div>
                        <div class="col-12 col-md-6">
                            <p><strong class="gray">g)</strong> RAYOGAS S.A. ESP controlará la operación de
                                sus
                                procesos de negocio
                                garantizando la seguridad de los recursos tecnológicos y las redes de datos.
                            </p>
                            <p><strong class="gray">h)</strong> RAYOGAS S.A. ESP implementará control de
                                acceso
                                a la información, sistemas y
                                recursos de red.</p>
                            <p><strong class="gray">i)</strong> RAYOGAS S.A. ESP garantizará que la
                                seguridad
                            ...
                            <p><strong class="gray">k)</strong> RAYOGAS S.A. ESP garantizará la
                                disponibilidad
                                de sus procesos de negocio y la
                                continuidad de su operación basado en el impacto que pueden generar los
                                eventos.
                            </p>
                            <p><strong class="gray">l)</strong> RAYOGAS S.A. ESP garantizará el cumplimiento
                                de
                                ...
                                traerá consigo, las consecuencias legales que apliquen a la normativa sobre
                                la
            ...
            <div class="row politics__privacity">
                <div class="col-12">
                    ...
                    <p>El Usuario reconoce y acepta que todos los derechos de propiedad intelectual sobre
                        ...
                        igualmente
                        las citas que utilicen contenidos gratuitos y/o elementos insertados en el Sitio
                        Web,
                        ...
                        modificación, alteración o traducción, así como en general todo uso que resulte
                        contrato
