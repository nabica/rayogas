        ...
        <div class="transparency__card mb-5">
            <div class="row">
                <div class="col-12 transparency__card-header">
                    <img src="{{ asset('images/web/transparency/icn_transparencia_control.png') }}" alt="">
                    <h2>Control</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                    ...
                    <p>RAYOGAS S.A. E.S.P. cuenta con el acompañamiento de la firma JGF CONSULTORES SAS
                        ...
                        2017, 20201000010485 de 2020.</p>
                    <p>
                        En el Sistema único de información se encuentra toda la información de RAYOGAS sobre
